<template>
  <div class="max-w-6xl mx-auto px-4 py-8">
    ...
    <div class="text-center mb-12">
      <h1 class="text-3xl font-bold text-gray-900">TV Mount Installation<sup class="text-sm bg-purple-500 text-white px-1 rounded ml-1">AI</sup></h1>
      <p class="text-gray-600 mt-2">Configure your TV mount installation settings for optimal viewing experience</p>
    </div>
      ...
      <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="aspect-video bg-gray-100 rounded-lg flex items-center justify-center mb-6">
          <div class="relative w-full h-full">
            ...
            <!-- 电视机示意图 -->
            <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-3/4 h-1/2 border-4 border-gray-300 rounded-lg bg-white"></div>
            <!-- 安装点 -->
            <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 grid grid-cols-2 gap-16">
            ...
            <!-- 测量线 -->
            <div class="absolute bottom-1/4 left-1/2 transform -translate-x-1/2 w-1 h-16 bg-red-500 border-l-2 border-dashed border-red-500"></div>
          </div>
        </div>
        ...
        <p class="text-sm text-gray-600 mt-6">
          Please measure the distance between the bottom mounting holes and the bottom edge of your TV according to the diagram above. This will help us calculate the optimal mounting height for your viewing experience.
        </p>
      </div>
    </div>
