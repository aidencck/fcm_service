  ...
  <div class="max-w-6xl mx-auto px-3 py-4">
    ...
    <div class="text-center mb-6">
      <h1 class="text-lg font-bold text-gray-900">
        TV Mount<sup class="text-xs bg-purple-500 text-white px-1 rounded ml-1">AI</sup>
      </h1>
      <p class="text-xs text-gray-600 mt-2">
        Ergonomically based smart choice TV mount installation is highly recommended, your TV starts
      </p>
    </div>
